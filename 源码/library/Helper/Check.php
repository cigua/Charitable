...
class Helper_Check{
	 ...
	 * @return boolean
	 * @example Helper_Check::isEmailAddr( 'lancer.he@gmail.com' );
	 */
	 ...
	 * @param string $string  需要匹配的字符串
	 * @return boolean
	 * @example Helper_Check::isHttpUrl( 'http://www.baidu.com' );
	 */
	 ...
	 * @param string $string  需要匹配的字符串
	 * @return boolean
	 * @example Helper_Check::isEmptyString( 'A' );
	 */
	 ...
	 * @return boolean
	 * @example Helper_Check::isNumber( '2131' );
	 */
	 ...
	 * @return boolean
	 * @example Helper_Check::isLengthBetween( 'Nickname' );
	 */
	 ...
	 * @return boolean
	 * @example Helper_Check::isValueBetween( 97, 4 ,10);
	 */
	 ...
	 * @param interger $max     最大长度
	 * @return boolean
	 * @example Helper_Check::isUsername( 'Lancer' );
	 */
	 ...
	 * @param interger $max  最大长度
	 * @return boolean
	 * @example Helper_Check::isPassword( 'Lancer' );
	 */
	 ...
	 * @return boolean
	 * @example Helper_Check::isSame( 'Lancer', 'Lancer2' );
	 */
	 ...
	 * @return boolean
	 * @example Helper_Check::isMobile( '15960720246' );
	 */
	 ...
	 * @return boolean
	 * @example Helper_Check::isNickname( '风华正茂' );
	 */
	 ...
	 * @param string $string
	 * @return boolean
	 * @example Helper_Check::isChinese( '风华正茂' );
	 */
	 ...
	 * @param string $string
	 * @return boolean
	 * @example Helper_Check::isContainsChinese( '风华正茂' );
	 */
	 ...
	 * @param string $string
	 * @return boolean
	 * @example Helper_Check::isIDCard( '350104198625141254' );
	 */
