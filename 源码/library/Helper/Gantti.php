...
class Helper_Gantti {
    ...
    function render() {
        ...
        foreach($this->blocks as $i => $block) {
            ...
            $html[] = '<span class="gantt-span" style="left: ' . $left . 'px; height: ' . $height . 'px">'. $this->blocks[$i]['span'] . '</span>';
            $html[] = '<span class="gantt-status" style="left: ' . ($left - 50) . 'px; height: ' . $height . 'px">'. $this->blocks[$i]['status'] . '</span>';
            $html[] = '</li>';
