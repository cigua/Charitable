...
class CompanyImgModel extends BaseModel {

    public function __construct()
    {
        parent::__construct('charity', 't_company_img', 'ci_id');
    }
    ...
    public function deleteData($id){
        return $this->_db->delete($this->_table)->from($this->_table)->where('c_id', $id)->execute();
    }
    /**
     * 保存数据
     *
